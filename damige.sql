...
-- -----------------------------------------------------
-- Table `damige`.`Driver State`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `damige`.`Driver State` ;

CREATE TABLE IF NOT EXISTS `damige`.`Driver State` (
...
CREATE TABLE IF NOT EXISTS `damige`.`idCard` (
  ...
  CONSTRAINT `fk_idCard_Driver State1`
    ...
    REFERENCES `damige`.`Driver State` (`State_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `damige`.`Driver` (
  ...
  `Driver name` VARCHAR(45) NULL,
  `Supplier ID` VARCHAR(10) NOT NULL,
  `Card ID` VARCHAR(10) NOT NULL,
  PRIMARY KEY (`Driver id`),
  INDEX `fk_Driver_Supplier1_idx` (`Supplier ID` ASC),
  INDEX `fk_Driver_Driver Id Card1_idx` (`Card ID` ASC),
...
CREATE TABLE IF NOT EXISTS `damige`.`Vehicle` (
  ...
  `Supplier ID` VARCHAR(10) NOT NULL,
  PRIMARY KEY (`VRN`),
  INDEX `fk_Vehicle_Supplier_idx` (`Supplier ID` ASC),
...
CREATE TABLE IF NOT EXISTS `damige`.`Delivery` (
  ...
  INDEX `fk_Delivery_Venue1_idx` (`Venue ID` ASC),
  INDEX `fk_Delivery_Vehicle1_idx` (`VRN` ASC),
  INDEX `fk_Delivery_Supplier1_idx` (`Supplier ID` ASC),
  INDEX `fk_Delivery_Driver1_idx` (`Driver id` ASC),
